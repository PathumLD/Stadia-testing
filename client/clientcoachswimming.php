            ...
            <table class="table">
                ...
                <?php
                    if(isset($_POST['go'])){
                        ...
                        $query = "SELECT * FROM coach_classes WHERE sport='swimming'AND email = '$email'  AND status = (1 || 2) ";

                    } else{

                        $query = "SELECT * FROM coach_classes WHERE sport='swimming'  AND status = (1 || 2) ";
                    }
                    $res = mysqli_query($linkDB, $query); 
                    if($res == TRUE) {
