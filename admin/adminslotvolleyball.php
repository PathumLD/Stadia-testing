      ...
      $(document).ready(function() {
        var loggedInUserEmail = "<?php echo $_SESSION['email']; ?>";
          var calendar = $('#calendar').fullCalendar({
            ...
            events: 'adminslotvolleyballload.php',
            views: {
                month: {
                  selectable: false
                },
            ...
            select: function(start, end, allDay)
            {
              ...
              for (var i = 0; i < numSlots; i++) {
                ...
                $.ajax({
                  url:"adminslotvolleyballinsert.php",
                  type:"POST",
            ...
            eventResize:function(event)
            {
              if (event.email !== loggedInUserEmail) {
                ...
                $.ajax({
                  url:"adminslotvolleyballupdate.php",
                  type:"POST",
              ...
              eventClick:function(event)
              {
               ...
               // get today's date
                  ...
                  if(confirm("Are you sure you want to remove it?"))
                  {
                      var id = event.id;
                      $.ajax({
                          url:"adminslotvolleyballdelete.php",
                          type:"POST",
                          data:{id:id},
                          success:function()
                          {
