...
<html lang="en" dir="ltr">
  ...
  $(document).ready(function() {
   var calendar = $('#calendar').fullCalendar({
    ...
    events: 'adminslotbadmintonload.php',
    selectable:true,
    selectHelper:true,
    select: function(start, end, allDay)
    {
     ...
     if(title)
     {
      ...
      $.ajax({
       url:"adminslotbadmintoninsert.php",
       type:"POST",
    ...
    eventResize:function(event)
    {
     ...
     var id = event.id;
     $.ajax({
      url:"adminslotbadmintonupdate.php",
      type:"POST",
    ...
    eventClick:function(event)
    {
     if(confirm("Are you sure you want to remove the slot?"))
     {
      var id = event.id;
      $.ajax({
       url:"adminslotbadmintondelete.php",
       type:"POST",
       data:{id:id},
       success:function()
       {
