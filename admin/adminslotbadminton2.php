      ...
      $(document).ready(function() {
        var loggedInUserEmail = "<?php echo $_SESSION['email']; ?>";
          var calendar = $('#calendar').fullCalendar({
            ...
            events: 'adminslotbadminton2load.php',
            views: {
                month: {
                  selectable: false
                },
            ...
            select: function(start, end, allDay)
            {
              ...
              calendar.fullCalendar('adminEvents', function(existingEvent) {
              ...
              for (var i = 0; i < numSlots; i++) {
                ...
                $.ajax({
                  url:"adminslotbadminton2insert.php",
                  type:"POST",
            ...
            eventResize:function(event)
            {
              if (event.email !== loggedInUserEmail) {
                ...
                $.ajax({
                  url:"adminslotbadminton2update.php",
                  type:"POST",
            ...
            eventDrop:function(event, delta, revertFunc)
              ...
              eventClick:function(event)
              {
                ...
                if (loggedInUserEmail !== 'fiyaza.fb@gmail.com' && event.email !== loggedInUserEmail) {
               ...
               // get today's date
                  ...
                  if(confirm("Are you sure you want to remove it?"))
                  {
                      var id = event.id;
                      $.ajax({
                          url:"adminslotbadminton2delete.php",
                          type:"POST",
                          data:{id:id},
                          success:function()
                          {
