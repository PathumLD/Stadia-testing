    ...
    <script>
      $(document).ready(function() {
          ...
          var calendar = $('#calendar').fullCalendar({
            ...
            events: 'bookingsbadminton2load.php',
            views: {
                month: {
                  selectable: false
                },
            ...
            select: function(start, end, allDay)
            {
              ...
              for (var i = 0; i < numSlots; i++) {
                ...
                $.ajax({
                  url:"bookingsbadminton2insert.php",
                  type:"POST",
            ...
            eventResize:function(event)
            {
              if (event.email !== loggedInUserEmail) {
                ...
                $.ajax({
                  url:"bookingsbadminton2update.php",
                  type:"POST",
            ...
            eventClick:function(event)
              {
                if (event.email !== loggedInUserEmail) {
                  ...
                  if(confirm("Are you sure you want to remove it?"))
                  {
                      var id = event.id;
                      $.ajax({
                          url:"bookingssbadminton2delete.php",
                          type:"POST",
                          data:{id:id},
                          success:function()
                          {
            ...
            <div class="content">
              ...
              <div class="segmented-control">
                ...
                <label for="tab-1" class= "segmented-control__1">
                  <p><a href="managerbookingsbadminton2.php">Court 1</a></p>
                </label>
