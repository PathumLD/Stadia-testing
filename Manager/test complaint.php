...
<?php
        ...
        if (mysqli_num_rows($result) > 0) {
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<td><form method='post'><input type='hidden' name='class_id' value='" . $row["class_id"] . "'><button class='btn-new' type='submit' name='verify-n'><i class='fa fa-check' aria-hidden='true'></i></button>
            </form></td>";
echo "</tr>";
