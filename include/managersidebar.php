<div class="logo">
    ...
    <div class="nav-links">
        ...
        <a href="managercoaches.php"><i class="fa fa-id-badge" aria-hidden="true"></i><span class="links_name">Coaches</span></a>
        <button class="dropdown-btn"><i class="fa fa-users" ></i><span class="links_name">Classes</span>
            <i class="fa fa-caret-down"></i>
        </button>
        <div class="dropdown-container">
            
          <a href="managercoachesbadminton.php">Badminton</a>
          <a href="managercoachesbasketball.php">Basketball</a>
          <a href="managercoachesvolleyball.php">Volleyball</a>
          <a href="managercoachestennis.php">Tennis</a>
        ...
        <div class="dropdown-container">
            ...
            <a href="managerviewordersrefreshments.php">Refreshments</a>
            <a href="managerviewordersequipments.php">Equipments</a>
